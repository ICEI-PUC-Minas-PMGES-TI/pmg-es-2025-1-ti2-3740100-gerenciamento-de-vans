...
public class TelaCadastroController {
    ...
    @GetMapping("/todos")
    public ResponseEntity<List<TelaCadastro>> getAllUsers() {
    try {
        Iterable<TelaCadastro> usuariosIterable = repository.findAll();
        List<TelaCadastro> usuarios = new ArrayList<>();
        usuariosIterable.forEach(usuarios::add);  // Converte Iterable para List
